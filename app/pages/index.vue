  ...
  <UContainer>
    <div class="max-w-4xl mx-auto py-8">
      <div class="text-center mb-8">
        <UBadge variant="subtle" class="mb-4">Nuxt x Supabase</UBadge>
        <h1 class="text-3xl font-bold mb-4">Todo List.</h1>
        <p class="text-gray-600">Demo of a simple todo list app using Nuxt and Supabase.</p>
      </div>
            ...
            <UCard variant="subtle">
              <ul>
                <li
                  v-for="task of tasks"
                  :key="task.id"
                  class="border-b border-gray-200 dark:border-gray-800 last:border-b-0 py-3 first:pt-0 last:pb-0"
                >
                  <div class="flex items-center justify-between gap-2 min-w-0">
                    ...
                    <div class="flex items-center gap-2">
                      <USwitch
                        ...
                        size="lg"
                        @update:model-value="(value) => { task.completed = value; completeTask(task); }"
                      />
                      <UButton
                        variant="link"
                        icon="i-lucide-trash"
