...
deploy-todo-apprunner: commit-changes
	...
	aws apprunner create-service \
		...
		--source-configuration "{\"CodeRepository\":{\"RepositoryUrl\":\"https://github.com/$(GITHUB_REPO)\",\"SourceCodeVersion\":{\"Type\":\"BRANCH\",\"Value\":\"$(BRANCH)\"},\"CodeConfiguration\":{\"ConfigurationSource\":\"API\",\"CodeConfigurationValues\":{\"Runtime\":\"NODEJS_16\",\"BuildCommand\":\"npm ci && npm run build\",\"StartCommand\":\"npm start\",\"Port\":\"3000\",\"RuntimeEnvironmentVariables\":{\"NODE_ENV\":\"production\",\"NITRO_PRESET\":\"node-server\"}}}},\"AutoDeploymentsEnabled\":true,\"AuthenticationConfiguration\":{\"ConnectionArn\":\"$$CONNECTION_ARN\"}}" \
